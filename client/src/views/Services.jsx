        ...
        <div>
            ...
            <div className="grid grid-cols-6 gap-10 mx-12 p-[20px]  lg:mt-12">
                ...
                <div className="col-start-1 col-end-3 ">
                    <div className=" relative shadow-xl hover:scale-[1.05] transition duration-700 ease-in-out rounded-lg p-5 overflow-hidden " style={{ backgroundRepeat: "no-repeat", backgroundSize: "cover", backgroundPosition: "center" }} >
