    ...
    <div className="contact-form">
      ...
      <div className="lg:grid lg:min-h-screen lg:grid-cols-12">
        <section className="relative flex h-32  lg:col-span-5 lg:h-full xl:col-span-6">
          <p>Need assistance or have a question? We're here to help! Whether you’re looking to book a test, understand your results, or learn more about our services, feel free to reach out. Your health is our priority.</p>
        </section>
